  ...
  ngOnInit() {
    ...
    try {
      const schema = {
        ...
        description: 'Ankara\'da 1998\'den beri doğalgaz tesisatı, kombi servisi, kaskat tesisatı, klima montaj ve sıhhi tesisat hizmetleri. 27+ yıl deneyim. 7/24 acil servis.',
        url: 'https://enkay.com',
